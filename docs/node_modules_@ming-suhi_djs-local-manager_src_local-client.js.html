...
<head>
    ...
    <meta charset="utf-8">
    <title>node_modules/@ming-suhi/djs-local-manager/src/local-client.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">node_modules/@ming-suhi/djs-local-manager/src/local-client.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const CommandsManager = require('./managers/commands-manager.js');
...
module.exports = LocalClient;</code></pre>
        </article>
    </section>
