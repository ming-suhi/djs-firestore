...
<head>
    ...
    <meta charset="utf-8">
    <title>node_modules/@ming-suhi/djs-local-manager/src/managers/commands-manager.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">node_modules/@ming-suhi/djs-local-manager/src/managers/commands-manager.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const Folder = require('../structures/folder.js');
...
module.exports = CommandsManager;</code></pre>
        </article>
    </section>
