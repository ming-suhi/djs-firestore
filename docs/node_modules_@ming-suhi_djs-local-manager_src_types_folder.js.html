...
<head>
    ...
    <meta charset="utf-8">
    <title>node_modules/@ming-suhi/djs-local-manager/src/types/folder.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">node_modules/@ming-suhi/djs-local-manager/src/types/folder.js</h1>
 ...
 * @typedef {string} folderPath path from root leading to folder
 */

/**
 * @typedef {array&lt;fileData>} folderData array of file data
 */</code></pre>
        </article>
    </section>
