...
<head>
    ...
    <meta charset="utf-8">
    <title>node_modules/@ming-suhi/djs-local-manager/src/structures/folder.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">node_modules/@ming-suhi/djs-local-manager/src/structures/folder.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const {getFiles} = require('../utilities/folder.js');
